...
STDMETHODIMP GLDirect3DTexture9::GetSurfaceLevel(UINT Level, IDirect3DSurface9** ppSurfaceLevel) { if (ppSurfaceLevel) { *ppSurfaceLevel = new GLDirect3DSurface9(); } return D3D_OK; }

STDMETHODIMP GLDirect3DSurface9::GetDesc(D3DSURFACE_DESC *pDesc) { if (pDesc) { pDesc->Format = D3DFMT_A8R8G8B8; pDesc->Type = D3DRTYPE_SURFACE; pDesc->Width = 1024; pDesc->Height = 768; } return D3D_OK; }
STDMETHODIMP GLDirect3DSurface9::LockRect(D3DLOCKED_RECT* pLockedRect, CONST RECT* pRect, DWORD Flags) { return E_NOTIMPL; }
STDMETHODIMP GLDirect3DSurface9::UnlockRect() { return D3D_OK; }
