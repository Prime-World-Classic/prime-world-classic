...
inline int f2l_nosse(float f)
{
  ...
  int nI;
   __asm
  {
    fld         dword ptr[f]            // �������� �������� float
    fnstcw      word ptr[cwOld]         // ���������� FPUCW
    movzx       eax, word ptr[cwOld]
    or          eax, 0x0c00             // ��������� ������ ���������� � ������� ���� (truncate)
    mov         dword ptr[cwNew], eax
    fldcw       word ptr[cwNew]         // �������� ������ �������� FPUCW
    fistp       dword ptr[nI]           // ���������� �������� int
    fldcw       word ptr[cwOld]         // �������������� FPUCW
  }
  return nI;
}
...
inline int f2l_sse3(float f)
{
  ...
  {
    fld         dword ptr[f] // �������� �������� float
    fisttp      dword ptr[nI] // ���������� �������� int � ������ truncate
  }
  return nI;
}
