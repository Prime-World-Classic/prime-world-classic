...
namespace NGameX
{
  ...
  //////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////
	...
	bool AdventureCameraController::SetCameraAnchor( PFClientBaseUnit* pObject )
	{
		...
		return SetCameraAnchor( pObject->GetPosition().pos, pObservingObject.GetPtr() != pObject );
	}
    ...
    {
      SetCameraAnchor( pObservingObject.GetPtr() );
	...
	{
		return pObservingObject.GetPtr() == pObject;		
	}
