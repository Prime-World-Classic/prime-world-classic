    ...
    // ==================== WASD пїЅпїЅпїЅпїЅпїЅпїЅпїЅпїЅ ====================
      ...
      case 'd':
      {
          ...
          if (moveDir != VNULL3)
          {
              ...
              CVec3 targetPos = heroPos + moveDir * 18.0f; // пїЅпїЅпїЅпїЅпїЅпїЅпїЅпїЅпїЅпїЅ пїЅпїЅпїЅпїЅпїЅ пїЅпїЅпїЅпїЅпїЅпїЅ
...
CVec3 AdventureScreen::GetMoveDirectionFromKey(int key) const
{
    ...
    // пїЅпїЅпїЅпїЅпїЅпїЅпїЅпїЅ пїЅпїЅпїЅпїЅпїЅпїЅпїЅ пїЅ пїЅпїЅпїЅпїЅпїЅпїЅпїЅпїЅпїЅпїЅ пїЅпїЅпїЅпїЅпїЅпїЅ
    NScene::SCameraPosition camPos;
    camera->GetPosition(&camPos);

    // Forward (пїЅпїЅпїЅпїЅпїЅпїЅпїЅпїЅпїЅпїЅпїЅ пїЅпїЅпїЅпїЅпїЅпїЅпїЅ пїЅпїЅпїЅпїЅпїЅпїЅ)
    CVec3 forward = camPos.GetCameraDir();
    forward.z = 0.0f;                    // пїЅпїЅпїЅпїЅпїЅпїЅпїЅ пїЅпїЅпїЅпїЅпїЅпїЅпїЅпїЅпїЅпїЅпїЅпїЅ пїЅпїЅпїЅпїЅпїЅпїЅпїЅпїЅпїЅпїЅпїЅпїЅ
    forward.NormalizeSelf();

    // Right (пїЅпїЅпїЅпїЅпїЅпїЅ пїЅпїЅ пїЅпїЅпїЅпїЅпїЅпїЅ). пїЅпїЅпїЅпїЅпїЅпїЅпїЅпїЅпїЅ пїЅпїЅпїЅпїЅпїЅ cross product
    ...
    switch (tolower(key))
    {
    case 'w': moveDir = forward;  break;   // пїЅпїЅпїЅпїЅпїЅ
    case 's': moveDir = -forward; break;   // пїЅпїЅпїЅпїЅпїЅ
    case 'a': moveDir = -right;   break;   // пїЅпїЅпїЅпїЅпїЅ
    case 'd': moveDir = right;    break;   // пїЅпїЅпїЅпїЅпїЅпїЅ
    }
