...
void Window::ProcessWindowCoords( LinearCoord & resultOffs, LinearCoord & resultSize, NDb::EUIElementHAlign align, //��, ��� ��� ����
  ERecalcRectsReason reason, //���������, ��� ����� ��������� - size ��� offset
  LinearCoord prevOffs, LinearCoord newOffs, LinearCoord prevSize, LinearCoord newSize, //���������� ��������, ������ � �����
  LinearCoord prevParentSize, LinearCoord newParentSize ) //������� ��������, ������ � �����
{
  NI_ASSERT( 
...
void Window::OnDataChanged()
{
  ...
  RecalcThisWindowRects( eRecalcByParent ); //@iA@TODO: ������� ��� ���� ��� eRecalcByData??
...
void Window::LoadLayout( const NDb::ClonedPtr< NDb::UILayout > &newLayout )
{
  ...
  //@iA@TODO: ���������� ���� �� ������� RecalcThisWindowRects _�����_ �������� ������, ���� ��� � ��� ����
  //������ ��� ������� ���������� ��� ������� ����� ��������
...
int GetIndexFromString( lua_State * L )
{
  ...
  if( lua_type( L, 1 ) != LUA_TSTRING ) //FIXME: ����� ����� ��������� NI_VERIFY
    return -1;
