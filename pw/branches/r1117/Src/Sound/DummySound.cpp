...
namespace NSoundScene
{
  ...
  bool GetEventLength( FMOD::Event *pEvent, int &_lenght, bool isNeedMultiLanguageLength ) { _lenght = 0; return false; }
  FMOD::Event* GetEvent( const NDb::DBFMODEventDesc & eventDesc ) { return 0; }
  FMOD::Event* EventStart( const NDb::DBFMODEventDesc& eventDesc ) { return 0; }
