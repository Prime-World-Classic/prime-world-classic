...
// ���������� ��� ���� ����� ��������, ����������� �� CObjectBase, ������������ � ������� ������.
// ������� PrintObjectsStatistics() ���������� �� ������� ������ Ctrl+Shift+M (���� print_object_statistics)
//#define TRACK_COBJECTS
// ���� �������� ���� ������ �� ���������� ����������, �� � ������� ����� ����� ������������ 
// cobj_track_references <hex address> [<depth=0..5>]
// ��. ������ �� confluence "������������� CObj & CPtr � ������".
...
/// ���� OBJECT_METHODS( <TypeID>, <className> ): � ��� ����������� ����������� ������, 
/// ����������� � IObjectBase.
...
#define OBJECT_ABSTRACT_METHODS( className )																																									\
	public:																																																											\
		...
		const int IsInvalidRef() const { return this->IsInvalidRefInternal(); }																													\
...
#define OBJECT_BASIC_METHODS( className )																																											\
	...
	public:																																																											\
		...
		{																																																													\
			this->~className();																																																			\
			int nHoldRef = this->nRefCount;																																																\
			int nHoldObj = this->nObjCount;																																																\
      ::new(this) className();																																																\
			this->nRefCount += nHoldRef;																																																	\
			this->nObjCount += nHoldObj;																																																	\
		}																																																													\
