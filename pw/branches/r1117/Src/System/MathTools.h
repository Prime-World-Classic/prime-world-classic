...
#define FP_BITS_CONST( fp ) ( *(const unsigned int*)(&(fp)) )
// floating pt 1.0
...
// ��������� ������� ������, ���������� �� DWORD'��
// ************************************************************************************************************************ //
inline void MemSetDWord( void* lpData, const unsigned int value, const int nCount )
{
  #ifdef WIN32
    _asm
    {
    ...
    #else
      unsigned int *dest = (unsigned int*)lpData;
