...
//       }
    ...
    void GuildWarEventrPointsCalculator::CalculatePoints( vector<roll::SUserAward> & playersAwards  )
    {
      ...
      for(;awIter != playersAwards.end(); ++awIter)
      {
        ...
        awIter->awards.push_back(SAwardInfo(roll::EAwardType::ClanWarsClanRating, 0, clanPoints, 0, true)); // ��� � ������� ������ ������������ � ���������� � � �������� �������� ������� � ������
        awIter->awards.push_back(SAwardInfo(roll::EAwardType::GuildWarEventPoints, 0, clanPoints, 0, true)); // ��� �� ����� � ������������ ��������, � ����� ������������� � �����������
      }
    }
