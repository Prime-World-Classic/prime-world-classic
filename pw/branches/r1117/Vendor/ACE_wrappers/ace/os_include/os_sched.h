...
// Patched: Don't redefine cpu_set_t when already defined by glibc
#if !defined (__cpu_set_t_defined) && !defined (__linux_cpu_set_t_defined) && !defined (ACE_HAS_CPU_SET_T)
