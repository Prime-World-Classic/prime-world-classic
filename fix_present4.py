...
if start_idx != -1 and end_idx != -1:
    ...
    if (g_sdlWindow) {
        ...
        // BLIT all possible UI FBOs to backbuffer
        ...
        // TINY GREEN PIXEL to show we are in this loop
        glDisable(GL_DEPTH_TEST); glUseProgram(0); glBegin(GL_POINTS); glColor3f(0,1,0); glVertex2f(-0.98f, -0.98f); glEnd();
    ...
    print("Present patched for FBO 1-5.")
else:
